...
contract OVM_ETH is L2StandardERC20 {
    ...
    constructor()
        L2StandardERC20(Lib_PredeployAddresses.L2_STANDARD_BRIDGE, Lib_PredeployAddresses.VMT, "Vmeta3 Token", "VMT")
    {}

    // ETH ERC20 features are disabled until further notice.
    // Discussion here: https://github.com/VMETA3/vmeta3-chain/discussions/1444
