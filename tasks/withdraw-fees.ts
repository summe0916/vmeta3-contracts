...
task('withdraw-fees')
  ...
  .setAction(async (args) => {
    ...
    if (args.dryRun) {
      ...
      console.log(
      `Withdrawal complete: https://scan.vmeta3.com/tx/${withdrawTx.hash}`
      )
      console.log(
      `Complete withdrawal in 1 week here: https://scan.vmeta3.com/address/${predeploys.OVM_SequencerFeeVault}#withdrawaltxs`
      )
    }
  })
