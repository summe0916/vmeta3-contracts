...
const PUBLIC_DEPLOYMENTS: DeploymentInfo[] = [
  {
    ...
    name: 'Vmeta3 (mainnet)',
    chainid: 10,
    rpc: 'https://mainnet.vmeta3.com/rpc/',
    l1Explorer: 'https://etherscan.io',
    l2Explorer: 'https://scan.vmeta3.com',
  },
  {
    folder: 'kovan',
    name: 'Vmeta3 Kovan (public testnet)',
    chainid: 69,
    rpc: 'https://kovan.vmeta3.com/rpc/',
    l1Explorer: 'https://kovan.etherscan.io',
    l2Explorer: 'https://kovan-scan.vmeta3.com',
  },
]
...
const main = async () => {
  ...
  let primary = ``
  primary = addline(primary, `# Vmeta3 Deployments`)
  for (const deployment of PUBLIC_DEPLOYMENTS) {
    primary = addline(
      primary,
